...
> 一款**跨平台**的学术文献深度剖析提示词 / 技能。无论是 WorkBuddy、Claude、ChatGPT、Cursor、Gemini 等主流助手，还是任意支持「自定义指令 / System Prompt / Skills」的 AI 助手，都能装上它。
...
| 二、一分钟速览 | ≤200 字高密度概括 + ★1–5 星阅读推荐指数 |
...
PaperJoy 本质是一份**结构化提示词**，不是独立程序——它不自带分析引擎，而是把能力「借」给运行它的基础模型。因此：
